...
function Results({ className, input }) {
  ...
  return (
    <div className={className}>
      <TextInput value={round(results.totalArea, 1)} inputClassName="w-24" label="總面積" disabled />
      <TextInput
        className="mt-1"
...
function App() {
  ...
  return (
    <div className="flex flex-col">
      <h1 className={"text-center text-3xl mt-20"}>谁更便宜?</h1>
      ...
      <p className="text-center mt-5 text-lg">
         <span className="font-bold">{cheaperPizzaName}</span>批薩更便宜!</p>
    </div>
  );
}
