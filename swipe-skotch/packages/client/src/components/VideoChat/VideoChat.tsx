import React, { useState, useRef, useEffect } from '../../assets/pages/Home/node_modules/react';
import Peer, { SignalData } from '../../assets/pages/Game/node_modules/simple-peer';
