         ...
         <div className="row">
            <div className="eight columns">
               ...
               <form id="contactForm" name="contactForm">
                  ...
                  <div>
                     <label htmlFor="contactMessage">信息 <span className="required">*</span></label>
                  ...
                  <div>
                     <button type='submit' onClick={handleClick} className="submit">提交</button>
